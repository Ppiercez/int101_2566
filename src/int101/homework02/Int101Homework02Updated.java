...
public class Int101Homework02Updated {
       ...
       1.5 Show in this "work01Utilitor" method how to
           use 1.2-1.4 and check their correctness. */
            System.out.println(Utilitor.testString("Pierce"));
            System.out.println(Utilitor.testPositive(20));
            System.out.println(Utilitor.computeIsbn10(456851265));
        }
       ...
       2.11 Show in this "work02Person" method how to
            ...
            Person s = new Person("Phurin","Suwannarat");
            System.out.println(s);
            Person j = new Person("John","Cena");
       ...
       3.13 Show in this "work03Account" method how to
            ...
            Person s = new Person("Phurin","Suwannarat");
            Account banks = new Account(s);
            Person j = new Person("John","Cena");
            Account bankj = new Account(j);
            banks.deposit(2000);
            banks.withdraw(1000);
            bankj.deposit(10000);
            bankj.withdraw(5000);
            System.out.println(banks);
            System.out.println(bankj);
        }
}
